...
urlpatterns = [
    path('employees/', views.employees_list, name='employees-list'), # Updated time null when it insert the database- Done
    path('employee/', views.employee_list, name='employee-list'),
    path('employee/create/', views.employee_create, name='employee-create'), # Validate the fields optional
