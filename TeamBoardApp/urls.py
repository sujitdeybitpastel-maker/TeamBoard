...
urlpatterns = [
    ...
    path('project/add_member/', views.project_add_member, name='project-add-member'), #Implement here
    path('test/add/', views.test_add, name='test-add'),
    path('project/remove_member/', views.project_remove_member, name='project_remove_member'),# Implement Here
    path('project/members/', views.project_members_list, name='project_member'), # Implement Here
